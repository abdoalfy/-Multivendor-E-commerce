            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-product">
                    <div class="product-image">
                        <span class=" sale-tag">{{ $product->discount_sale}}</span>
                        <img src="{{ $product->image_url }}" alt="#">
                        <div class="button">
                            <a href="#" class="btn"><i class="lni lni-cart add-to-cart" data-id="{{ $product->id }}"></i> Add to Cart</a>
                        </div>
                    </div>
                    ...
                    <div class="product-info">
                        ...
                        <h4 class="title">
                            <a href="{{ route('singelproduct',$product->slug) }}">{{ $product->name }}</a>
                        </h4>
                        <ul class="review">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <div class="single-product">
                            <div class="product-image">
                                ...
                                <div class="button">
                                    <a href="product-details.html" class="btn"><i class="lni lni-cartadd-to-cart" data-id="{{ $product->id }}"></i> Add to
                                        Cart</a>
                                </div>
                            </div>
                            <div class="product-info">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        ...
                        <div class="single-product">
                            <div class="product-image">
                                <img src="https://via.placeholder.com/335x335" alt="#">
                                <div class="button">
                                    <a href="product-details.html" class="btn"><i class="lni lni-cart add-to-cart" data-id="{{ $product->id }}"></i> Add to
                                        Cart</a>
                                </div>
                            </div>
                            <div class="product-info">
