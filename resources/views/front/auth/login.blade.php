                ...
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3 col-7">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <img src="{{ asset('assets/assets/images/logo/logo.svg') }}" alt="Logo">
                        </a>
                        <!-- End Header Logo -->
                    </div>
                                    ...
                                    <div class="shopping-item">
                                        ...
                                        <ul class="shopping-list">
                                            <li>
                                                ...
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="product-details.html"><img
                                                            src="{{ asset('assets/assets/images/header/cart-items/item1.jpg') }}" alt="#"></a>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="product-details.html"><img
                                                            src="{{ asset('assets/assets/images/header/cart-items/item2.jpg') }}" alt="#"></a>
                                                </div>
                                                <div class="content">
                        ...
                        <div class="card-body">
                           ...
                           @endif
                            <div class="form-group input-group">
                                ...
                                <input class="form-control @if('error') error @endif" name="email" type="email" id="reg-email" required>
                            </div>
                            <div class="form-group input-group">
                            ...
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                <div class="form-check">
                                    <input type="checkbox" value="1" name="remember" class="form-check-input width-auto" id="exampleCheck1">
